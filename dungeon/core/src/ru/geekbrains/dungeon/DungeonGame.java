...
public class DungeonGame extends Game {
    ...
    // Герой похоже у нас получается бессмертный: когда его здоровье зануляется, он не исчезает.
    // Более того, его здоровье может уходить в минус. Из-за этого иногда появляется NullPointerException

    // По задаче 5. Возможно, юниту нужно добавлять доспехи в виде массива типа доспех и потом вычитать сумму
    // сопротивлений этого массива доспехов к соответствующему виду оружия
